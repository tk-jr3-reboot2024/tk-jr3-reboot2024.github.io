			...
			<ThemeProvider theme={theme}>
				...
				<Box sx={{ padding: '2vw', box_width: '100%', background: grey[50], borderRadius: '4px' }}>
					...
					<Typography variant="p">
						...
						<br />
						　また、デコ責は夏休み明けのこの時期に大量の書類の締め切りに追われた。
						<br />
						<Box
							component="img"
							src={making055}
						...
						【文化祭まで残り10日】
						<br />
						　広報班でビラやポスターのデザインを着々と作成。
						<br />
						　また、裏で撮影班が映画の編集を進めている最中。
						<br />
						【文化祭まで残り7日】
						<br />
						　文化祭の装飾がまだ全然できておらず、危機感を持った人達で装飾作業を進めた。画像は立て看板の作成風景。
						<br />
						　また、脚本班でクライマックスの方針を決定した。
						<br />
						<Box
							component="img"
							src={making007}
						...
						【文化祭まで残り5日】
						<br />
						　この日の学活で全員が集まるシーンを撮影して、撮影が終了！ここからは編集班がひたすら編集に尽力した。
						<br />
						【文化祭まで残り4日】
						<br />
						...
						<br />
						　また、ついに映像が完成し、試写会が開かれた。編集班には感謝の限りである。
						<br />
						<Box
							component="img"
							src={making001b}
						...
						/>
						【文化祭当日】
						　こうして、皆様に映画「翔んで筑駒」をお届けすることができました。
						<br />
					</Typography>
				</Box>
			</ThemeProvider>
